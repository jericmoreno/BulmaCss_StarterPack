...
gulp.task('sass', function(){
    return gulp.src(['node_modules/bulma/sass/bulma.sass', 'src/scss/*.scss'])
    .pipe(sass())
    .pipe(gulp.dest("src/css"))
...
gulp.task('default', ['js', 'serve', 'fa', 'fonts', 'bulm']);
...
gulp.task('prodfonts', function(){
    return gulp.src('src/fonts/fontawesome/*')
    .pipe(gulp.dest("production/fonts/fontawesome"));
});
